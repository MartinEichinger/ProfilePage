...
class Projects extends Component {
    constructor(props) {
        ...
        this.h1Opacity = (12*(this.scroll - (this.posProjects-this.vwh/2)) / this.posProjects);
        ...
        this.cards = [
            ...
            },
            {
                ...
                finalDate: '11/2020',
                shortDesc: 'With this ressource management web application different teams can be created and managed. The team members can then be scheduled by project managers in their projects in a weekly chart',
                backend: 'Django, django-rest-auth for user auth, Django REST framework to create web API',
                frontend: 'React.js, React/Redux, react-router-dom, material-ui, axios and css-in-js lib emotion',
            },
            {
                id: 'card4',
                ...
                summary: 'Twitter like social network website for making posts and following users',
                finalDate: '10/2020',
                shortDesc: 'With the social network web application you can register and signin. The user can view all posts from the network and follow other users. Details are described in the video.',
                backend: 'Django',
            ...
            },
            {
                ...
                finalDate: '04/2020',
                shortDesc: 'Search website to find the best locations in the city of your choice for your search term.',
                backend: '-',
    ...
    render () {
        ...
        return ( 
            <div className="projects" css={this.styleProjects} ref={this.posRef}>
                <h1>Projects</h1>
