        ...
        <div css={styleWelcome} ref={posRef}>
            ...
            <div className="row-out row"> 
                <div className="col-md-6" id='img'>
                    <div className="img" css={styleFixImg}>
                    </div>
                </div>
                <div className="col-md-6">
                    <div className="text col align-items" css={styleFixText} >
                        <section>
                            <div className="content">
                                <p className="mt-5">Hi, my name is "Ed Madd" Martin.</p>
                            </div>
                        </section>
                        <section>
                            <div className="content">
                        ...
                        <section>
                            <div className="content">
                                <p>Are you? Then check out my site and projects!</p>
                            </div>
                        </section>
                        <section>
                            <div className="content">
                                <p>If you like what you see here, have ideas,  interesting or funny insights related to web development then let me know.</p>
                            </div>
                        </section>
                        <section>
                            <div className="content">
