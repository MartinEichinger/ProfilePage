...
class App extends Component {
  ...
  render() {
    console.log("App/render: ", this.state.rotation, this.posProjectsRef.current);
    return (
      <div css={this.styleApp} className="App">
        <Navigation onClick={this.onClickPos} rotation={this.state.rotation}/>
        <LandingPage />
        <Welcome  scroll={this.state.theposition} posWelcome={this.pos2} posSkill={this.pos3} posRef={this.posWelcomeRef} />
        <Skills scroll={this.state.theposition} posSkill={this.pos3} posProjects={this.pos4} posRef={this.posSkillsRef} />
        <Projects scroll={this.state.theposition} posProjects={this.pos4} posRef={this.posProjectsRef} />
